...
{
    public partial class Form_Multiplication : Form
    {
        public int NombreMultiplication = 0;
        public int Succes = 0;

        public Form_Multiplication()
        {
            InitializeComponent();
        }
        ...
        private void button_Test_Click(object sender, EventArgs e)
        {
            ...
            Multiplication();
            AfficheNombre();
            NombreMultiplication++;
            buttonCommencer.Text = "Multiplication Suivante : " + NombreMultiplication.ToString() + "/10";
            textBox_Resultat.Text = "";
            if (NombreMultiplication == 10)
            {
                buttonCommencer.Text = "Résultat";
                AfficheResultat();
                NombreMultiplication++;
            }
            if (NombreMultiplication == 11)
                this.Close();
